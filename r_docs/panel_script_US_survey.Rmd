...
# two-way anova: vote and time on cn

anova_cn <- aov(cn ~ vote + time, data = US)
summary(anova_cn)
...
```{r}
# fc_1_o_agr
fc_1_cn.mod <- lm(scale(fc_1_o_agr.2) ~ scale(cn.2), data = US_wide_Rep) # N = 52
summary(fc_1_cn.mod)
plot(fc_1_cn.mod)
...
fc_1_cn.mod_clean <- lm(scale(fc_1_o_agr.2) ~ scale(cn.2), data = US_wide_Rep_clean1) # N = 49
summary(fc_1_cn.mod_clean)
plot(fc_1_cn.mod_clean)


# adding secident and fc_1_o_agr.1 (with outliers removed)
fc_1_cn.mod2 <- lm(scale(fc_1_o_agr.2) ~ scale(cn.2) + scale(secident.2) + scale(fc_1_o_agr.1), data = US_wide_Rep)
...
fc_1_cn.mod2a <- lm(scale(fc_1_o_agr.2) ~ scale(cn.2) + scale(secident.2) + scale(fc_1_o_agr.1), data = US_wide_Rep)
summary(fc_1_cn.mod2a)
confint(fc_1_cn.mod2a)

# adding further covariates (with outliers removed)
fc_1_cn.mod3 <- lm(scale(fc_1_o_agr.2) ~ scale(cn.2) + scale(secident.2) + scale(fc_1_o_agr.1) + scale(sd.2) + scale(cor_values.2) + scale(cor_health.2), data = US_wide_Rep_clean1)
summary(fc_1_cn.mod3)

# without outlier removal
fc_1_cn.mod3a <- lm(scale(fc_1_o_agr.2) ~ scale(cn.2) + scale(secident.2) + scale(fc_1_o_agr.1) + scale(sd.2) + scale(cor_values.2) + scale(cor_health.2), data = US_wide_Rep)
summary(fc_1_cn.mod3a)




# fc_2_o_agr
fc_2_cn.mod <- lm(scale(fc_2_o_agr.2) ~ scale(cn.2), data = US_wide_Rep) # N = 52
summary(fc_2_cn.mod)
plot(fc_2_cn.mod)
...
fc_2_cn.mod_clean <- lm(scale(fc_2_o_agr.2) ~ scale(cn.2), data = US_wide_Rep_clean2) # N = 51
summary(fc_2_cn.mod_clean)

# adding secident & fc_2_o_agr t1 
fc_2_cn.mod2 <- lm(scale(fc_2_o_agr.2) ~ scale(cn.2) + scale(secident.2) + scale(fc_2_o_agr.1), data = US_wide_Rep) # N = 51
summary(fc_2_cn.mod2)
confint(fc_2_cn.mod2)
plot(fc_2_cn.mod2) # issues with linearity 
vif(fc_2_cn.mod2)
crPlots(fc_2_cn.mod2)
durbinWatsonTest(fc_2_cn.mod2)
...
# adding further covariates (with outliers removed)
fc_2_cn.mod3 <- lm(scale(fc_2_o_agr.2) ~ scale(cn.2) + scale(secident.2) + scale(fc_2_o_agr.1) + scale(sd.2) + scale(cor_values.2) + scale(cor_health.2), data = US_wide_Rep_clean2) # N = 51
summary(fc_2_cn.mod3)

# without outlier removal
fc_2_cn.mod3a <- lm(scale(fc_2_o_agr.2) ~ scale(cn.2) + scale(secident.2) + scale(fc_2_o_agr.1) + scale(sd.2) + scale(cor_values.2) + scale(cor_health.2), data = US_wide_Rep) # N = 52
summary(fc_2_cn.mod3a)



# behavioural intention
sign_cn.mod <- glm(sign.2 ~ scale(cn.2), data = US_wide_Rep, family = "binomial")
...
sign_cn.mod2 <- glm(sign.2 ~ scale(cn.2) + scale(secident.2) + sign.1, data = US_wide_Rep, family = "binomial")
...
sign_cn_pred <- data.frame(cn.2 = 4, secident.2 = 6, sign.1 = 1)
...
```{r}
# joy
joy_fc_1.mod <- lm(scale(joy.2) ~ scale(fc_1_o_agr.2), data = US_wide_Rep)
...
joy_fc_1.mod_clean <- lm(scale(joy.2) ~ scale(fc_1_o_agr.2), data = US_wide_Rep_clean3)
...
joy_fc_2.mod <- lm(scale(joy.2) ~ scale(fc_2_o_agr.2), data = US_wide_Rep)
...
joy_fc_2.mod_clean <- lm(scale(joy.2) ~ scale(fc_2_o_agr.2), data = US_wide_Rep_clean4)
summary(joy_fc_2.mod_clean)

# eff

eff_fc_1.mod <- lm(scale(eff.2) ~ scale(fc_1_o_agr.2), data = US_wide_Rep)
...
eff_fc_1.mod_clean <- lm(scale(eff.2) ~ scale(fc_1_o_agr.2), data = US_wide_Rep_clean5)
summary(eff_fc_1.mod_clean)
plot(eff_fc_1.mod_clean)
confint(eff_fc_1.mod_clean)


eff_fc_2.mod <- lm(scale(eff.2) ~ scale(fc_2_o_agr.2), data = US_wide_Rep)
...
sign_fc_1.mod <- glm(sign.2 ~ scale(fc_1_o_agr.2), data = US_wide_Rep, family = "binomial")
...
# adding sign.1 
sign_fc_1.mod2 <- glm(sign.2 ~ scale(fc_1_o_agr.2) + sign.1, data = US_wide_Rep, family = "binomial")
...
sign_fc_2.mod <- glm(sign.2 ~ scale(fc_2_o_agr.2), data = US_wide_Rep, family = "binomial")
...
# adding sign.1 
sign_fc_2.mod2 <- glm(sign.2 ~ scale(fc_2_o_agr.2) + sign.1, data = US_wide_Rep, family = "binomial")
...
sign_joy.mod <- glm(sign.2 ~ scale(joy.2), data = US_wide_Rep, family = "binomial")
...
# adding sign.1 
sign_joy.mod2 <- glm(sign.2 ~ scale(joy.2) + sign.1, data = US_wide_Rep, family = "binomial")
...
sign_eff.mod <- glm(sign.2 ~ scale(eff.2), data = US_wide_Rep, family = "binomial")
...
# adding sign.1 
sign_eff.mod2 <- glm(sign.2 ~ scale(eff.2) + sign.1, data = US_wide_Rep, family = "binomial")
...
sign_joint.mod1 <- glm(sign.2 ~ scale(cn.2) + scale(joy.2), data = US_wide_Rep, family = "binomial")
summary(sign_joint.mod1)
exp(coef(sign_joint.mod1))
exp(confint(sign_joint.mod1))
pscl::pR2(sign_joint.mod) ["McFadden"]

# explorative: removing joy, adding secident
sign_joint.mod2 <- glm(sign.2 ~ scale(cn.2) + scale(secident.2), data = US_wide_Rep, family = "binomial")
...
sign_joint.mod3 <- glm(sign.2 ~ scale(cn.2) + scale(secident.2) + scale(joy.2), data = US_wide_Rep, family = "binomial")
...
sign_joint.mod4 <- glm(sign.2 ~ scale(cn.2) + scale(secident.2) + sign.1, data = US_wide_Rep, family = "binomial")
...
sign_joint.mod5a <- glm(sign.1 ~ scale(joy.1), data = US_wide_Rep, family = "binomial")
...
sign_joint.mod5 <- glm(sign.1 ~ scale(cn.1), data = US_wide_Rep, family = "binomial")
...
sign_joint.mod6 <- glm(sign.1 ~ scale(cn.1) + scale(joy.1), data = US_wide_Rep, family = "binomial")
...
sign_joint.mod7 <- glm(sign.1 ~ scale(cn.1) + scale(secident.1), data = US_wide_Rep, family = "binomial")
...
```{r}
joy_cn.mod <- lm(scale(joy.2) ~ scale(cn.2), data = US_wide_Rep)
summary(joy_cn.mod)
confint(joy_cn.mod)
plot(joy_cn.mod)
ncvTest(joy_cn.mod)# homoscedasticity assumption not violated

joy_cn.mod2 <- lm(scale(joy.2) ~ scale(cn.2) + scale(secident.2), data = US_wide_Rep)
summary(joy_cn.mod2)
confint(joy_cn.mod2)
plot(joy_cn.mod2)
ncvTest(joy_cn.mod2) # homoscedasticity assumption not violated

eff_cn.mod <- lm(scale(eff.2) ~ scale(cn.2), data = US_wide_Rep)
summary(eff_cn.mod)
plot(eff_cn.mod)
...
eff_cn.mod2 <- lm(scale(eff.2) ~ scale(cn.2) + scale(secident.2), data = US_wide_Rep)
summary(eff_cn.mod2)
plot(eff_cn.mod2)

bootResults <- Boot(eff_cn.mod2, R = 10000)
summary(bootResults)
boot.ci(bootResults, type = "bca", index = 2)
boot.ci(bootResults, type = "bca", index = 3)
```

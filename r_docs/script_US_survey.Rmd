...
ggplot(US_data, aes(x=cn_1))+
  ...
  labs(x = "CN_1", y = "Frequency") +
  theme_light()

ggplot(US_data, aes(x=cn_2))+
  stat_bin(colour="grey",fill="steelblue", geom = "bar") +
  labs(x = "CN_2", y = "Frequency") +
  theme_light()

ggplot(US_data, aes(x=cn_3))+
  stat_bin(colour="grey",fill="steelblue", geom = "bar") +
  labs(x = "CN_3", y = "Frequency") +
  theme_light()

ggplot(US_data, aes(x=cn_4))+
  stat_bin(colour="grey",fill="steelblue", geom = "bar") +
  labs(x = "CN_4", y = "Frequency") +
  theme_light()

ggplot(US_data, aes(x=cn_5))+
  stat_bin(colour="grey",fill="steelblue", geom = "bar") +
  labs(x = "CN_5", y = "Frequency") +
  theme_light()
...
ggplot(US_data, aes(x=xeno_1))+
  stat_bin(colour="grey",fill="steelblue", geom = "bar") +
  labs(x = "Xeno_1", y = "Frequency") +
  theme_light()

ggplot(US_data, aes(x=xeno_2))+
  stat_bin(colour="grey",fill="steelblue", geom = "bar") +
  labs(x = "Xeno_2", y = "Frequency") +
  theme_light()

ggplot(US_data, aes(x=xeno_3))+
  stat_bin(colour="grey",fill="steelblue", geom = "bar") +
  labs(x = "Xeno_3", y = "Frequency") +
  theme_light()

ggplot(US_data, aes(x=xeno_4))+
  stat_bin(colour="grey",fill="steelblue", geom = "bar") +
  labs(x = "Xeno_4", y = "Frequency") +
  theme_light()

ggplot(US_data, aes(x=xeno_5))+
  stat_bin(colour="grey",fill="steelblue", geom = "bar") +
  labs(x = "Xeno_5", y = "Frequency") +
  theme_light()

ggplot(US_data, aes(x=xeno_6))+
  stat_bin(colour="grey",fill="steelblue", geom = "bar") +
  labs(x = "Xeno_6", y = "Frequency") +
  theme_light()

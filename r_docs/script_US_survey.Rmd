...
fit_xeno <- cfa(xeno.model, data = xeno.cfa_clean, estimator = "MLR")
...
xeno.model2 <- 'Xenophobia =~ xeno_1 + xeno_2 + xeno_3 + xeno_4 +
xeno_6'

fit_xeno2 <- cfa(xeno.model2, data = xeno2.cfa_clean, estimator = "MLR")
...
xeno3.cfa_clean <- xeno2.cfa %>%
  filter(keep(xeno_1) &
           keep(xeno_2) &
           keep(xeno_3) &
           keep(xeno_4))

xeno.model3 <- 'Xenophobia =~ xeno_1 + xeno_2 + xeno_3 + xeno_4'

fit_xeno3 <- cfa(xeno.model3, data = xeno3.cfa_clean, estimator = "MLR")
